   ...
   @Override
    ...
    public String toString() {
        return String.format("Code: %s\nDescription: %s\nPrice: %s\nRelease Date: %s\nYears Released: %d",
                code, description, NumberFormat.getCurrencyInstance().format(price), releaseDate.format(DateTimeFormatter.ofPattern("MM/dd/yyyy")), getYearsReleased());
    }
    ...
    public int hashCode() {
        ...
        if (code != null) {
            answer = code.toLowerCase().hashCode();
        }
